...
Phiên bản có định dạng: `[Loại bản vá].[Số bản sửa]` (Ví dụ: `A.01`)
...
*   **vA.01**:
    - Thêm tính năng định dạng và dịch dữ liệu thô JSON sang giao diện Console (UI) trực quan, có màu sắc thân thiện và dễ đọc hiểu cho người dùng.
